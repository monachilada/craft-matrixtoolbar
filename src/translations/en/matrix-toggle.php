...
/**
 * Matrix Toggle en Translation
 *
 * Returns an array with the string to be translated (as passed to `Craft::t('matrix-toggle', '...')`) as
 ...
 */
return [
    'Matrix Toggle plugin loaded' => 'Matrix Toggle plugin loaded',
];
