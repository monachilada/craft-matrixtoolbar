...
namespace monachilada\matrixtoggle\records;
 ...
 * @since     1.0.0
 */
class MatrixToggleRecord extends ActiveRecord
{
    ...
    {
        return '{{%matrixtoggle_matrixtogglerecord}}';
    }
}
