...
namespace monachilada\matrixtoggle\fields;

use monachilada\matrixtoggle\MatrixToggle;
use monachilada\matrixtoggle\assetbundles\matrixtogglefieldfield\MatrixToggleFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class MatrixToggleField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('matrix-toggle', 'MatrixToggleField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'matrix-toggle/_components/fields/MatrixToggleField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(MatrixToggleFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').MatrixToggleMatrixToggleField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'matrix-toggle/_components/fields/MatrixToggleField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
