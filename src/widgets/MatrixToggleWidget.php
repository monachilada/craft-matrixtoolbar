...
namespace monachilada\matrixtoggle\widgets;

use monachilada\matrixtoggle\MatrixToggle;
use monachilada\matrixtoggle\assetbundles\matrixtogglewidgetwidget\MatrixToggleWidgetWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * Matrix Toggle Widget
 *
 ...
 * @since     1.0.0
 */
class MatrixToggleWidget extends Widget
{
    ...
    {
        return Craft::t('matrix-toggle', 'MatrixToggleWidget');
    }
    ...
    {
        return Craft::getAlias("@monachilada/matrixtoggle/assetbundles/matrixtogglewidgetwidget/dist/img/MatrixToggleWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'matrix-toggle/_components/widgets/MatrixToggleWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(MatrixToggleWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'matrix-toggle/_components/widgets/MatrixToggleWidget_body',
            [
